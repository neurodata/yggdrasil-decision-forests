...
ABSL_FLAG(std::string, output_dir, "/tmp/honest_kernel_forest",
          "Output directory to save the model and results");

// Honest Forest 
ABSL_FLAG(bool, enable_honest, true, "Enable honest forest");
ABSL_FLAG(float, honest_ratio, 0.367, "Honest ratio for leaf examples");
...
int main(int argc, char** argv) {
  ...
  LOG(INFO) << "=== Honest Forest w/wo Kernel Method Training ===";
  ...
  col_guide->set_column_name_pattern("income");
  ...
  LOG(INFO) << "Configure Honest Forest with Kernel Method";
  ...
  LOG(INFO) << "=== Honest Forest w/wo Kernel Method completed successfully! ===";
